<template>
  <div v-if="availableParts" class="content">
    ...
    <div class="top-row">
      ...
      <!-- <div class="top part" :style="{backgroundColor: 'red'}"> -->
...
export default {
  ...
  computed: {
    availableParts() {
      console.log('computed available parts');
      console.log(this.$store.state.robots.parts);
