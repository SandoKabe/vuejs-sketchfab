...
<button @click="initGui()">Click me to load model and show iframe.</button>
</template>

<script> //  src="./SketchfabApi.js"
...
export default {
    ...
    return {
      sketchfab: null,
      uid: 'b61ebca81f19445b9561d87df4f5fbdb',
      version: '1.12.0',
    }
  },
...
initGui() {
  ...
  let client =  new window.Sketchfab(this.version, iframe);
  this.init(client);
  var buttonsText = '';
